...
import os
os.environ["DATABASE_URL"] = 'postgresql://neondb_owner:npg_UBSCD7cj5hXz@ep-super-term-ajx1lzgj.c-3.us-east-2.aws.neon.tech/neondb?sslmode=require'
...
engine = create_engine('postgresql://neondb_owner:npg_UBSCD7cj5hXz@ep-super-term-ajx1lzgj.c-3.us-east-2.aws.neon.tech/neondb?sslmode=require')
try:
