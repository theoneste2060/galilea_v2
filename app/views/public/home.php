  ...
  <div class="container">
    <div class="newsletter-inner reveal" style="max-width:680px">
      ...
      <form id="inquiryForm" class="inquiry-form" autocomplete="on" novalidate>
        ...
        <div class="field-row">
          <div class="field"><input type="text" id="iq_name" name="full_name" placeholder=" " required><label for="iq_name">Full name *</label></div>
          <div class="field"><input type="email" id="iq_email" name="email" placeholder=" " required><label for="iq_email">Email address *</label></div>
        </div>
        <div class="field-row">
          <div class="field"><input type="text" id="iq_phone" name="phone" placeholder=" "><label for="iq_phone">Phone (optional)</label></div>
          <div class="field"><input type="text" id="iq_company" name="company" placeholder=" "><label for="iq_company">Company (optional)</label></div>
        </div>
        <div class="field is-select">
          <select id="iq_service" name="service_interest">
            <option value="General Inquiry">General inquiry</option>
            <?php foreach ($services as $svc): ?><option value="<?= esc($svc['title']) ?>"><?= esc($svc['title']) ?></option><?php endforeach; ?>
          </select>
          <label for="iq_service">Service of interest</label>
        </div>
        <div class="field"><textarea id="iq_msg" name="message" rows="4" placeholder=" " required></textarea><label for="iq_msg">Tell us about your shipment or request *</label></div>
